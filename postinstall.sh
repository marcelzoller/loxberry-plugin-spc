...
/bin/sed -i "s#REPLACEBYBASEFOLDER1#$LBHOMEDIR#" $LBHOMEDIR/system/cron/cron.05min/$PDIR
/bin/sed -i "s#REPLACEBYSUBFOLDER1#$PDIR#" $LBHOMEDIR/system/cron/cron.05min/$PDIR
/bin/sed -i "s#REPLACEBYBASEFOLDER2#$LBPBIN#" $LBHOMEDIR/system/cron/cron.05min/$PDIR
/bin/sed -i "s#REPLACEBYSUBFOLDER2#$PDIR#" $LBHOMEDIR/system/cron/cron.05min/$PDIR
